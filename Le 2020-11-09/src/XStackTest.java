...
class XStackTest {
    ...
    void testPush_tooMany() {
        ...
        XStack cut = new XStack();
        /*
         * Lägg till 11 tal på stacken. Det är en mer än vad den initialt kan innehålla,
         * den ska då automatiskt öka bufferten med 10 platser till så att det får plats
         * med 20 tal på stacken.
         */
        cut.push(3);
        cut.push(77);
        cut.push(3);
